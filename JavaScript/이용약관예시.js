...
<html >
  <head>
    ...
    <link href='https://cdn.rawgit.com/openhiun/hangul/14c0f6faa2941116bb53001d6a7dcd5e82300c3f/nanumbarungothic.css' rel='stylesheet' type='text/css'><!--약관 필요-->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet"><!--약관 필요-->
    <script
...
<body> 
        <table align=center>
            <tr>
                <td><input type="checkbox" id="checkall"/>모든 약관을 확인하고 전체 동의합니다.</td>
            </tr>
        </table>
        <input type="checkbox" name="chk" style="display: inline-block;"><p style="color:red;display: inline-block;">(필수)</p>1. 이용약관
        <div>
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
    ...
    <br>
    <input type="checkbox" name="chk" style="display: inline-block;"><p style="color:red; display: inline-block;">(필수)</p>2. 개인정보 수집 및 이용 동의
    <div>
        <input value="더보기" onclick="if(this.parentNode.getElementsByTagName('div')[0].style.display != '')
        {
          this.parentNode.getElementsByTagName('div')[0].style.display = '';
